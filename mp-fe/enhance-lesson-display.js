...
// Enhance lesson display to show material indicators
const oldLessonDisplay = `                      {lesson.duration && (
                        <Typography
                          variant="caption"
...
const newLessonDisplay = `                      {lesson.duration && (
                        <Typography
                          variant="caption"
                          sx={{ color: "rgba(255,255,255,0.5)" }}
                        >
...
content = content.replace(oldLessonDisplay, newLessonDisplay);
