...
import {
  ...
  ExpandMore,
  Home as HomeIcon,
  LibraryMusic as MultitrackIcon,
  PictureAsPdf as PdfIcon,
  AttachFile as ResourceIcon,
...
export default function CourseDetailPage() {
  ...
  const [state, setState] = useState({
    ...
    error: null,
    purchasing: false,
    activeLessonIndex: 0, // Changed from activeLessonIndex
    finishing: false,
  });
  ...
  const handleLessonSelect = (lesson, index) => {
    setState((prev) => ({ ...prev, activeLessonIndex: index }));
  };
              ...
              >
                ...
                {isEnrolled && lessons.length > 0 && (
                  <Box sx={{ mt: 3 }}>
                    <CourseProgress
                      progress={progress}
                      currentLesson={activeLessonIndex + 1}
